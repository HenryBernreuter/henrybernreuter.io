...
<title>Titanic Solution in Python 3 </title>
...
<p>Complete an analysis of who will survive the Titanic using machine learning.
1.Collect the data
2.Explore data  for analysis
3.Clean data for better visualizations</p>
...
<span class="c1">#Collect data using pandas read csv function</span>
<span class="n">train</span> <span class="o">=</span> <span class="n">pd</span><span class="o">.</span><span class="n">read_csv</span><span class="p">(</span><span class="s1">&#39;C:/Users/new user/Desktop/CTW4999/kaggle-titanic/input/train.csv&#39;</span><span class="p">)</span>
<span class="n">test</span> <span class="o">=</span> <span class="n">pd</span><span class="o">.</span><span class="n">read_csv</span><span class="p">(</span><span class="s1">&#39;C:/Users/new user/Desktop/CTW4999/kaggle-titanic/input/test.csv&#39;</span><span class="p">)</span>
</pre></div>
...
<div class="text_cell_render border-box-sizing rendered_html">
<p>First We need to look at what data has been collected</p>
...
<div class="text_cell_render border-box-sizing rendered_html">
<p>Third Identify the type of date per column. This is a good why to identify missing values. As you can see 'Age' and 'Cabin'
missing value</p>
...
<div class="text_cell_render border-box-sizing rendered_html">
<p>Fourth, Lets define what the columns mean
'Survived': 0 = No, 1 = Yes
...
<div class="text_cell_render border-box-sizing rendered_html">
<p>Fifth, Lets start making visualizations to explore the data. This is a great way to look for obvious corelations</p>
...
<div class="text_cell_render border-box-sizing rendered_html">
<p>My prefered method is to create a  chart function, instead of writing several plots. I can create several visualization quickly
simply by calling the chart function with differnet arguements.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="k">def</span> <span class="nf">bar</span><span class="p">(</span><span class="n">feature</span><span class="p">):</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">bar</span><span class="p">(</span><span class="s1">&#39;Sex&#39;</span><span class="p">)</span>
<span class="n">bar</span><span class="p">(</span><span class="s1">&#39;Pclass&#39;</span><span class="p">)</span>
<span class="n">bar</span><span class="p">(</span><span class="s1">&#39;SibSp&#39;</span><span class="p">)</span>
<span class="n">bar</span><span class="p">(</span><span class="s1">&#39;Parch&#39;</span><span class="p">)</span>
<span class="n">bar</span><span class="p">(</span><span class="s1">&#39;Embarked&#39;</span><span class="p">)</span>
</pre></div>
